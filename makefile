...
I3705 = ${I3705D}/i3705_cpu.c ${I3705D}/i3705_chan_T2.c ${I3705D}/i3705_scan_T2.c \
	${I3705D}/i3705_sys.c ${I3705D}/i3705_lib.c ${I3705D}/i3705_panel.c  
I3705_OPT = -I ${I3705D}
...
I3174D = I327x
I3174 = ${I3174D}/i3174_cc.c ${I3174D}/i3270_tn.c
I3174_OPT = -I ${I3174D}

DLSwD = DLSw
DLSw = ${DLSwD}/DLSw_rt.c 
DLSw_OPT = -I ${DLSwD}

TrunkD = Trunk
Trunk = ${TrunkD}/Trunk_cl.c 
Trunk_OPT = -I ${TrunkD}

CPanelD = CPanel
CPanel = ${CPanelD}/CPanel_hw.c 
CPanel_OPT = -I ${CPanelD}
...
${BIN}i3174${EXE} : ${I3174}
	${MKDIRBIN}
	${CC} ${I3174} ${I3174_OPT} $(CC_OUTSPEC) ${LDFLAGS} 
	
DLSw: ${BIN}DLSw${EXE}
	
${BIN}DLSw${EXE} : ${DLSw}
	${MKDIRBIN}
	${CC} ${DLSw} ${DLSw_OPT} $(CC_OUTSPEC) ${LDFLAGS} 
	
Trunk: ${BIN}Trunk${EXE}
	
${BIN}Trunk${EXE} : ${Trunk}
	${MKDIRBIN}
	${CC} ${Trunk} ${Trunk_OPT} $(CC_OUTSPEC) ${LDFLAGS} 
	
CPanel: ${BIN}CPanel${EXE}
	
${BIN}CPanel${EXE} : ${CPanel}
	${MKDIRBIN}
	${CC} ${CPanel} ${CPanel_OPT} $(CC_OUTSPEC) ${LDFLAGS} -lrt -lncurses
